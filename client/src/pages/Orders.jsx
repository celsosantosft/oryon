...
const styles = {
    ...
    customPrintingRow: { display: 'flex', gap: '10px', alignItems: 'center' },
    ...
    productLineTotals: { display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '12px', borderTop: '1px dashed #E2E8F0', paddingTop: '14px' },
