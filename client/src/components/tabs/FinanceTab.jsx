...
export const FinanceTab = ({ preview = false, remainingOrder, percentPaid, totalOrder, paidOrder, formatMoney }) => {
    return (
        <div className={`animate-fade-in${preview ? ' portal-tab portal-finance-tab' : ''}`} style={{ width: '100%', boxSizing: 'border-box' }}>
            <div className={preview ? 'portal-card portal-balance-card' : undefined} style={{
